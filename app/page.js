    ...
    return ContentService.createTextOutput(JSON.stringify({ status: "error", message: err.toString() })).setMimeType(ContentService.MimeType.JSON);
        ...
        {activeTab === 'promo_poster' && (
          <div className="space-y-5">
            ...
            {totalPosterPages > 1 && (
              <div className="p-3 bg-white border-3 border-black shadow-[3px_3px_0_#000] rounded-xl space-y-2.5 sm:space-y-0 sm:flex sm:items-center sm:justify-between sm:gap-3">
