...
export default function StoreFront({ initialCategorySlug = null }) {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans pb-24 sm:pb-20 selection:bg-[#FFE600] selection:text-black">
      ...
      {/* FLOATING WHATSAPP GROUP CTA (SIMPEL, ELEGAN, LOGO RESMI WA & TIDAK MEPET NAV MOBILE) */}
      <div className="fixed bottom-[84px] sm:bottom-6 right-3 sm:right-6 z-40 flex flex-col items-end pointer-events-auto">
        {/* Simple "Join Group!" badge */}
        <span className="font-black text-black bg-white px-2 py-0.5 border-2 border-black shadow-[2px_2px_0_#000] -rotate-3 text-[10px] sm:text-xs uppercase tracking-tight mb-1 animate-bounce">
          Join Group!
        </span>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#25D366] hover:bg-[#20ba5a] text-black font-black uppercase border-3 border-black shadow-[4px_4px_0_#000] hover:shadow-[6px_6px_0_#000] transition-all hover:-translate-y-0.5 active:translate-y-0.5 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl flex items-center gap-2 focus:outline-none focus:ring-4 focus:ring-black cursor-pointer"
          title="Gabung Grup WhatsApp D Store"
        >
